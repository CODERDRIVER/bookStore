...
function loadData() {
    for (var i = 0; i < message.length; i++) {
        ...
        $("#table").append('<tbody>'+
            ...
            '<div class="am-btn-toolbar">'+
            ' <div class="am-btn-group am-btn-group-xs">\n' +
            '         <button type="button" onclick="borrow(this)"  class="am-btn am-btn-default am-btn-xs am-text-secondary"><span class="am-icon-pencil-square-o"></span> Borrow</button>\n' +
...
function borrow(e)
{
    var bookName = e.parentNode.parentNode.parentNode.parentNode.childNodes[4].innerHTML;
    console.log(bookName);
    $('#my-prompt').modal({
        relatedTarget: this,
        onConfirm: function(e) {
